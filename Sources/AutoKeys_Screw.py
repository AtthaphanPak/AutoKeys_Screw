...
class CAutoFITs_Screw():
    ...
    def openDatabaseFile(self, file):
        ...
        if convertstatus is True:      
            ...
            try:
                ...
                operation = False
                current_path = file
                return  df_output, operation, current_path, CompactPathName
    ...
    def UploadDataToFITs(self, dataFrame, operation, current_path, CompactPathName):
        root = tk.Tk()
        root.withdraw()
        root.attributes("-topmost", True)
    ...
    def aggregateAllDataAndSaveToFile(self):
        ...
        for file in filesFound:
            minedData, operation, current_path, CompactPathName = CAutoFITs_Screw.openDatabaseFile(self, file)
            if minedData is False or operation is False or CompactPathName == "NG":
                continue
